...
<body>
            ...
            <div class="gtco-container">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            <li class="active"><a href="http://localhost/abrence/home">Home</a></li>
                            <li><a href="http://localhost/abrence/about">About</a></li>
        ...
        <div id="gtco-features-2">
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="gtco-video gtco-video-sm gtco-bg" style="background-image: url(assets/images/img_1.jpg); ">
        ...
        <div id="gtco-counter" class="gtco-bg gtco-cover gtco-counter" style="background-image:url(assets/images/img_bg_2.jpg);">
            <div class="overlay"></div>
            <div class="gtco-container">
                <div class="row">
                    <div class="display-t">
                    ...
                    <div class="gtco-tabs">
                        ...
                        <div class="gtco-tab-content-wrap">
                            ...
                            <div class="gtco-tab-content tab-content active" data-tab-content="1">
                                <div class="col-md-6">
                                    <div class="gtco-video gtco-bg" style="background-image: url(assets/images/img_1.jpg); ">
                                        <a href="https://vimeo.com/channels/staffpicks/93951774" class="popup-vimeo"><i class="icon-video"></i></a>
                                        <div class="overlay"></div>
                                    </div>
                                </div>
